...
arm_user="ubuntu"
arm_path="/home/ubuntu/software/FastNIC/lab_new/${lab}"
...
# or
# /home/ubuntu/software/FastNIC/lab_new/lab_simplex/rules/myovs_rule_install0_quick.sh
...
ssh ${arm_user}@${arm_ip} "${arm_path}/script/${lab_s}/myovs_rule_install0.sh"
# ssh ${arm_user}@${arm_ip} "${arm_path}/script/${lab_s}/myovs_rule_install0_quick.sh"
...
do
    ...
    echo -e "\n"
    ssh -p 1022 ${user}@${recv_ip} "$run_path/script/start_sta.sh $remotefile $line $recv_host 18-35 $run_path \"$rcv_run_para\" "
